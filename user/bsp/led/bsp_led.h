...
#define RGB_RED_LED_GPIO_PIN 		        (12U)
#define RGB_RED_LED_IOMUXC			          IOMUXC_GPIO_B0_12_GPIO2_IO12

#define RGB_GREEN_LED_GPIO 				      GPIO2
#define RGB_GREEN_LED_GPIO_PIN 		        (14U)
#define RGB_GREEN_LED_IOMUXC			      IOMUXC_GPIO_B0_14_GPIO2_IO14

#define RGB_BLUE_LED_GPIO 				      GPIO2
#define RGB_BLUE_LED_GPIO_PIN 		        (16U)
#define RGB_BLUE_LED_IOMUXC			          IOMUXC_GPIO_B1_00_GPIO2_IO16

#define RGB_WHITE_LED_GPIO 				      GPIO2
#define RGB_WHITE_LED_GPIO_PIN 		        (18U)
#define RGB_WHITE_LED_IOMUXC			      IOMUXC_GPIO_B1_02_GPIO2_IO18
