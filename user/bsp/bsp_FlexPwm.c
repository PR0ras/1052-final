...
{
    //更新电机1占空比
   PWM_UpdatePwmDutycycle(Pwm2,kPWM_Module_1,kPWM_PwmA,kPWM_CenterAligned,pwm_Reference); //更新PWMB占空比
   PWM_SetPwmLdok(Pwm2,kPWM_Control_Module_1,true);    //设置PWM的load ok位 

    //更新电机2占空比
   PWM_UpdatePwmDutycycle(Pwm2,kPWM_Module_1,kPWM_PwmB,kPWM_CenterAligned,pwm_Reference+pwm_Difference); //更新PWMB占空比
   PWM_SetPwmLdok(Pwm2,kPWM_Control_Module_1,true);    //设置PWM的load ok位 
}

void DJ_PWM_Reload(uint32_t Offset)  //Median中值  Offset偏移量
{
    //更新舵机占空比
   PWM_UpdatePwmDutycycle(Pwm2,kPWM_Module_1,kPWM_PwmB,kPWM_CenterAligned, Median + Offset); //更新PWMB占空比
   PWM_SetPwmLdok(Pwm2,kPWM_Control_Module_1,true);    //设置PWM的load ok位 
}
